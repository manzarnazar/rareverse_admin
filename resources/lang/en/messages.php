...
return [
    ...
    "The_tin_certificate_must_not_exceed_5MB" => "The SAT fiscal certificate (Constancia) must not exceed 5MB",
    "vendor_name" => "Vendor name",
    "A/C_No" => "A/C No",
    "vendor_POS" => "Vendor POS",
    "Max_5_MB" => "Max 5 MB",
    "File_size" => "File size",
    "The_tin_certificate_must_be_a_file_of_type_pdf_doc_docx" => "The SAT fiscal certificate (Constancia) must be a file of type pdf doc docx",
    "The_tin_expire_date_must_be_a_future_date" => "The expiry date must be today or a future date",
    "The_tin_expire_date_must_be_a_valid_date_format" => "The expiry date must be a valid date format",
    "The_tin_expire_date_field_is_required" => "The expiry date field is required",
    "The_tin_identification_number_must_be_string" => "The RFC must be a string",
    "The_tin_identification_number_field_is_required" => "The RFC field is required",
    ...
    "The_tin_certificate_must_be_a_file_of_type_pdf_doc_docx_jpg" => "The SAT fiscal certificate (Constancia) must be a file of type pdf doc docx jpg",
    "tin_number" => "RFC",
    "cash_on_Delivery" => "Cash on Delivery",
    ...
    "type_your_TIN_number" => "Enter your RFC",
    ...
    "provide_vendor_business_tin_and_related_information_for_taxpayer_verification" => "Provide the vendor RFC and SAT fiscal certificate (Constancia) for tax verification",
    ...
    "provide_your_business_tax_id_and_related_information_for_taxpayer_verification" => "Provide your RFC and SAT fiscal certificate (Constancia) for tax verification",
    "here_you_can_see_your_business_tin_certificate." => "Here you can view your SAT fiscal certificate (Constancia).",
