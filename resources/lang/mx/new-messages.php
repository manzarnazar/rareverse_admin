...
return [
	...
	"The_tin_certificate_must_not_exceed_" => "La Constancia de Situación Fiscal (SAT) no debe exceder ",
	"TIN_expiry_date_must_be_today_or_later." => "La fecha de vigencia debe ser hoy o una fecha posterior.",
	"The_tin_certificate_must_be_a_file_of_type:_" => "La Constancia de Situación Fiscal (SAT) debe ser un archivo de tipo: ",
	"The_tin_certificate_may_not_be_greater_than_" => "La Constancia de Situación Fiscal (SAT) no puede ser mayor que ",
