            ...
            <div class="card-body">
                <div class="bg-section rounded-10 p-12 p-sm-20">
                    <div class="row align-items-end">
                        ...
                        @php
                            $wholesaleTiers = old('wholesale_tiers', []);
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="wholesale_tiers" id="vendor-wholesale-tiers-input" value='@json($wholesaleTiers)'>
                                <div class="table-responsive border rounded">
                                    <table class="table table-sm mb-0" id="vendor-wholesale-tier-table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody id="vendor-wholesale-tier-rows"></tbody>
                                    </table>
                                </div>
                                <button type="button" class="btn btn-outline-primary btn-sm mt-2" id="vendor-add-wholesale-tier-row">
                                    {{ translate('Add_Tier') }}
                                </button>
                            </div>
                        </div>
...
<script>
    (function () {
        const rowsContainer = document.getElementById('vendor-wholesale-tier-rows');
        const addRowButton = document.getElementById('vendor-add-wholesale-tier-row');
        const tiersInput = document.getElementById('vendor-wholesale-tiers-input');
