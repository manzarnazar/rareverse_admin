                    ...
                    <div class="row gy-4 align-items-end">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="wholesale_tiers" id="admin-wholesale-tiers-input" value='@json($wholesaleTiers)'>
                                <div class="table-responsive border rounded">
                                    <table class="table table-sm mb-0" id="admin-wholesale-tier-table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody id="admin-wholesale-tier-rows"></tbody>
                                    </table>
                                </div>
                                <button type="button" class="btn btn-outline-primary btn-sm mt-2" id="admin-add-wholesale-tier-row">
                                    {{ translate('Add_Tier') }}
                                </button>
                            </div>
                        </div>
...
<script>
    (function () {
        const rowsContainer = document.getElementById('admin-wholesale-tier-rows');
        const addRowButton = document.getElementById('admin-add-wholesale-tier-row');
        const tiersInput = document.getElementById('admin-wholesale-tiers-input');
