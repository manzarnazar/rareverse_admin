            ...
            <div class="card-body">
                <div class="bg-section rounded-10 p-12 p-sm-20">
                    <div class="row gy-4 align-items-end">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label class="form-label">{{ translate('Wholesale_Tiers') }}</label>
                                <p class="fs-12 text-muted mb-2">{{ translate('set_quantity_based_unit_price_for_bulk_orders') }}</p>
                                <input type="hidden" name="wholesale_tiers" id="admin-update-wholesale-tiers-input" value='@json($wholesaleTiers)'>
                                <div class="table-responsive border rounded">
                                    <table class="table table-sm mb-0" id="admin-update-wholesale-tier-table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody id="admin-update-wholesale-tier-rows"></tbody>
                                    </table>
                                </div>
                                <button type="button" class="btn btn-outline-primary btn-sm mt-2" id="admin-update-add-wholesale-tier-row">
                                    {{ translate('Add_Tier') }}
                                </button>
                            </div>
                        </div>
...
<script>
    (function () {
        const rowsContainer = document.getElementById('admin-update-wholesale-tier-rows');
        const addRowButton = document.getElementById('admin-update-add-wholesale-tier-row');
        const tiersInput = document.getElementById('admin-update-wholesale-tiers-input');
